...
They are essentially the same. Both models do not take into account uncorrelated errors. The coefficients are computed in two different ways, and they agree with each other. The lm model uses Ordinary Least Squares and the gls model uses Restricted Maximum Likelihood.

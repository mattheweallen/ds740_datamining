...
k=13 is the best choice, because it minimizes the Mean Square Error in the validation set.
...
census = read.csv("C:/Users/irgepi/source/repos/ds740data/Census_income.csv")
...
valid.X.std = data.frame(Educ.valid.std, Age.valid.std, Sex01[-train])
```
...
```{r echo=FALSE}
library(class)
predictions = knn(train.X.std, valid.X.std, census$Income[train], k = 25)

table(predictions, census$Income[-train])
```

...
#labels
x = model.matrix(Volume ~ Girth + Height + GirthHeight + Girth2 + Girth2Height,data=trees)[,-1]
y = trees[,1]
n = dim(x)[1]
p = dim(x)[2]
...
<span style="color:DarkViolet">$\hat{\beta}_0$ = -2.552886e+01
$\hat{\beta}_1$ = 3.437740e+00  
$\hat{\beta}_2$ = 0  
$\hat{\beta}_3$ = 0  
$\hat{\beta}_4$ = 0 
$\hat{\beta}_5$ = -2.799844e-04</span>    

...
```
number of variables == 15 gives lowest MSE
...
se[15]
which(MSE <= MSE[15] + se[15])
#based on one standard error rule choose 5, most parsimonious,
coef(regfit,5)
```
...
5 variables is the most parsimonious model with a CV error within 1 standard error of the lowest.
<span style="color:green">**Numeric Answer**  </span> **<span style="color:red">(AUTOGRADED on D2L)</span>**: 

...
The QDA fit overall is a little better. It is significantly better at predicting Japanese origin.
...
The Henze-Zirkler test concludes that the assumption of multivariate normality is not true. Since the assumption is not met the QDA model is not appropriate.
